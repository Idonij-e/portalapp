...
from school_portal.models import ClassLevel, SessionYearModel
...
class AddStudentForm(forms.Form):
    ...
    profile_pic=forms.ImageField(label="Profile Pic",widget=forms.FileInput(attrs={"class":"form-control"}))
